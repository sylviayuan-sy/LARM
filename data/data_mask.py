...
class Dataset(Dataset):
    def __init__(self, dataset_list, num_views, resolution, config=default_config, part_finetune=False, rot_aug=False):
        super().__init__()
        self.config = config
        ...
        try:
            ...
            for idx_chosen, (camera, image_path) in enumerate(
                ...
                if self.is_part:
                    ...
                    input_depth = input_depth + 0.5 if self.rot_aug else np.clip(input_depth, 0.0, 5.0) / 5.0
