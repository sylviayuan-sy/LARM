...
class Dataset(TorchDataset):
    def __init__(self, data_path, rot_aug=False):
        super().__init__()
    ...
    def get_pairs(self, idx):
        ...
        depth_0 = np.load(im_path_0.replace(".png", "_depth.npy")) + 0.5 if self.rot_aug else np.load(im_path_0.replace(".png", "_depth.npy")) * 5.0
        ...
        depth_1 = np.load(im_path_1.replace(".png", "_depth.npy")) + 0.5 if self.rot_aug else np.load(im_path_1.replace(".png", "_depth.npy")) * 5.0
