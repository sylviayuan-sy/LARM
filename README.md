...
With a new range of depth clipping, different input data rendering schemes, and change in model activation, the two models yield different results. The rotation augmented model yields better mesh reconstruction results especially with the TSDF method, while the original model does better in NVS. 

**Download sample data and model (rotation augmented) here**: [Rotation Augmented Model and Data](https://drive.google.com/drive/folders/1W6Th7UMJoovQOy3Mjp5P6J3nH8s4Jjrx?usp=drive_link)
