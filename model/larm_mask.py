...
def unpatchify(decoded_tokens, patch_size, image, extrinsic_out, extrinsic_in, rot_aug=False):
    ...
    return torch.cat([
        ...
        result_mask,
        result_depth.tanh() if rot_aug else result_depth.sigmoid(),
...
class LARM(nn.Module):
    ...
    def forward(self, intrinsic, extrinsic_in, extrinsic_out, image, qpos_in=None, qpos_out=None):
        ...
        return unpatchify(decoded, self.patch_size, image, extrinsic_out, extrinsic_in, self.rot_aug)
